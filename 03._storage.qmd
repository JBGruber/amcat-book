...
if ("state_of_the_union" %in% list_indexes()$name) {
  delete_index(index = "state_of_the_union")
  system(command = "docker exec amcat4 amcat4 create-test-index")
}
```
...
Now that we have a better idea of what and index is and how it looks like, we can create a new one>
