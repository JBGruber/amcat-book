...
```bash
docker exec -t amcat4 amcat4 add-admin your-email@example.com
docker exec -t amcat4 amcat4 create-env -a admin -p supergeheim
```

#### R

```r
dockr::docker_exec(id = "amcat4", "amcat4 add-admin your-email@example.com")
dockr::docker_exec(id = "amcat4", "amcat4 create-env -a admin -p supergeheim")
```
