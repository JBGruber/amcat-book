...
```bash
docker exec -it amcat4 amcat4 add-admin admin
docker exec -it amcat4 amcat4 create-env -a admin -p supergeheim
```

#### R

```r
dockr::docker_exec(id = "amcat4", "amcat4 add-admin admin")
