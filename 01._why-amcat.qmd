...
-   [`nextcat`](https://github.com/ccs-amsterdam/nextcat) offers a user interface, which makes it easy to **query documents from `amcat4` via a web interface**, share data with collaborators or the public and present your corpora to stakeholders, the community or the public
